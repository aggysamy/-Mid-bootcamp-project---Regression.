...
# Qn1: Create a database called `house_price_regression`. 
CREATE DATABASE house_price_regression;
# Qn2:  Create a table `house_price_data`
#with the same columns as given in the csv file. 
...
CREATE TABLE house_price_data (
	...
	sqft_lot15 INT,
	price INT);
# Qn3: show you the status of the variable ‘local_infile’. If it is off
SET GLOBAL local_infile = 1;
# Q4: Select all the data from table house_price_data to check if the data was imported correctly
SELECT *
FROM house_price_data;
#Q5: Drop the column date from the database. 
ALTER TABLE house_price_data DROP date_sold;
#Select all the data from the table to verify if the command worked. Limit your returned results to 10.
SELECT * FROM house_price_data
LIMIT 10; 

#Q6: Find how many rows of data you have.
SELECT COUNT(*)
FROM house_price_data;

#Q7: Find the unique values in some of the categorical columns
...
# Q8: Arrange the data in a decreasing order by the price of the house. Return the IDs of the top 10 most expensive houses.
